...
var comics = require('../public/comics')({
    publicKey: 'd2446f098f63d08b4988838e8f900060'
    , privateKey: 'b380902cad5dd109768db104d10a5661d3c6a3fc'
}, utils);
...
describe('comics', function() {
    ...
    beforeEach(function() {
        ts = utils.timestamp();
        hash = utils.createHash(ts, comics.privateKey, comics.publicKey);
    });
